...
public final class RealConnection implements Connection {
      ...
      try {
        ...
        if (address.getHostnameVerifier().verify(address.getUriHost(), sSLSocket.getSession())) {
          ...
          if (address.getCertificatePinner() != CertificatePinner.DEFAULT) {
            ...
            CertificateChainCleaner certificateChainCleaner = new CertificateChainCleaner();
            this(trustRootIndex);
            List list = certificateChainCleaner.clean(handshake.peerCertificates());
  ...
  public int allocationLimit() {
    ...
    if (framedConnection != null) {
      bool = framedConnection.maxConcurrentStreams();
    } else {
      bool = true;
    } 
    return bool;
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\internal\io\RealConnection.class
