...
public final class OkHeaders {
  ...
  public static Map<String, List<String>> toMultimap(Headers paramHeaders, String paramString) {
    TreeMap<String, Object> treeMap = new TreeMap<>(FIELD_NAME_COMPARATOR);
    int i = paramHeaders.size();
    for (byte b = 0; b < i; b++) {
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\internal\http\OkHeaders.class
