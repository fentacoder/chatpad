...
public final class RouteSelector {
  ...
  public Route next() throws IOException {
    ...
    Route route1 = new Route(this.address, this.lastProxy, this.lastInetSocketAddress);
    Route route2 = route1;
    if (this.routeDatabase.shouldPostpone(route1)) {
      this.postponedRoutes.add(route1);
      route2 = next();
    } 
    return route2;
  }
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\internal\http\RouteSelector.class
