    ...
    void receive(BufferedSource param1BufferedSource, long param1Long) throws IOException {
      while (param1Long > 0L) {
        synchronized (FramedStream.this) {
          ...
          l2 = param1BufferedSource.read(this.receiveBuffer, param1Long);
          if (l2 != -1L) {
            param1Long -= l2;
            synchronized (FramedStream.this) {
              if (this.readBuffer.size() == 0L) {
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\internal\framed\FramedStream.class
