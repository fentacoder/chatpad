  ...
  public NameValueBlockReader(BufferedSource paramBufferedSource) {
    this.inflaterSource = new InflaterSource((Source)new ForwardingSource((Source)paramBufferedSource) {
          public long read(Buffer param1Buffer, long param1Long) throws IOException {
            ...
            NameValueBlockReader.access$002(nameValueBlockReader, (int)(nameValueBlockReader.compressedLimit - param1Long));
            return param1Long;
          }
        }new Inflater() {
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\internal\framed\NameValueBlockReader.class
