...
final class Hpack {
  ...
  private static Map<ByteString, Integer> nameToFirstIndex() {
    LinkedHashMap<Object, Object> linkedHashMap = new LinkedHashMap<>(STATIC_HEADER_TABLE.length);
    byte b = 0;
    while (true) {
  ...
  static final class Reader {
    ...
    public List<Header> getAndResetHeaderList() {
      ArrayList<Header> arrayList = new ArrayList<>(this.headerList);
      this.headerList.clear();
      return arrayList;
    }
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\internal\framed\Hpack.class
