...
public final class Settings {
  ...
  boolean isPersisted(int paramInt) {
    boolean bool = true;
    if ((1 << paramInt & this.persisted) == 0)
      bool = false; 
    return bool;
  }
  ...
  boolean persistValue(int paramInt) {
    boolean bool = true;
    if ((1 << paramInt & this.persistValue) == 0)
      bool = false; 
    return bool;
  }
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\internal\framed\Settings.class
