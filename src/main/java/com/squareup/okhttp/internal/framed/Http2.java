...
public final class Http2 implements Variant {
      ...
      while (true) {
        ...
        while (true) {
          ...
          if (b < j) {
            ...
            for (i = 0; i < m; i++) {
              int n = arrayOfInt1[i];
              String[] arrayOfString3 = FLAGS;
              int i1 = n | k;
              StringBuilder stringBuilder2 = new StringBuilder();
              stringBuilder2.append(FLAGS[n]);
              stringBuilder2.append('|');
              stringBuilder2.append(FLAGS[k]);
              arrayOfString3[i1] = stringBuilder2.toString();
              String[] arrayOfString4 = FLAGS;
              StringBuilder stringBuilder1 = new StringBuilder();
              stringBuilder1.append(FLAGS[n]);
              stringBuilder1.append('|');
              stringBuilder1.append(FLAGS[k]);
              stringBuilder1.append("|PADDED");
              arrayOfString4[i1 | 0x8] = stringBuilder1.toString();
            } 
            b++;
            continue;
          } 
  ...
  static final class Writer implements FrameWriter {
    ...
    public void pushPromise(int param1Int1, int param1Int2, List<Header> param1List) throws IOException {
      ...
      //   81: iconst_5
      //   82: iload #11
      //   84: invokevirtual frameHeader : (IIBB)V
      //   87: aload_0
      //   88: getfield sink : Lokio/BufferedSink;
      //   91: iload_2
      //   92: ldc 2147483647
      //   94: iand
      //   95: invokeinterface writeInt : (I)Lokio/BufferedSink;
      //   100: pop
      //   101: aload_0
      //   102: getfield sink : Lokio/BufferedSink;
      //   105: aload_0
      //   106: getfield hpackBuffer : Lokio/Buffer;
      //   109: lload #7
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\internal\framed\Http2.class
