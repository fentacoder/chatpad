...
public final class CertificateChainCleaner {
  ...
  public List<Certificate> clean(List<Certificate> paramList) throws SSLPeerUnverifiedException {
    ...
    ArrayDeque<Certificate> arrayDeque = new ArrayDeque<>(paramList);
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\internal\tls\CertificateChainCleaner.class
