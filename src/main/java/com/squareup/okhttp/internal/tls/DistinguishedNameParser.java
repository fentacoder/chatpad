...
final class DistinguishedNameParser {
        ...
        if (c != ';')
          if (c != '\\') {
            if (c != '+' && c != ',') {
              int k = this.end;
              this.end = k + 1;
              arrayOfChar1[k] = (char)arrayOfChar1[i];
              this.pos = i + 1;
              continue;
            } 
          } else {
  ...
  private String nextAT() {
    ...
    if (i < this.length) {
      ...
      if (j - i > 4) {
        char[] arrayOfChar1 = this.chars;
        if (arrayOfChar1[i + 3] == '.' && (arrayOfChar1[i] == 'O' || arrayOfChar1[i] == 'o')) {
          arrayOfChar1 = this.chars;
          i = this.beg;
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\internal\tls\DistinguishedNameParser.class
