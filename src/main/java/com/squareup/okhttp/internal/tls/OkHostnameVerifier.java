...
public final class OkHostnameVerifier implements HostnameVerifier {
  ...
  private boolean verifyHostName(String paramString, X509Certificate paramX509Certificate) {
    ...
    byte b2;
    for (b2 = b1; b1 < i; b2 = 1) {
      if (verifyHostName(paramString, list.get(b1)))
        return true; 
      b1++;
    } 
    if (b2 == 0) {
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\internal\tls\OkHostnameVerifier.class
