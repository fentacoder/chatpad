...
public class OkHttpClient implements Cloneable {
  ...
  private SSLSocketFactory getDefaultSSLSocketFactory() {
    ...
    //   42: aload_1
    //   43: athrow
    //   44: getstatic com/squareup/okhttp/OkHttpClient.defaultSslSocketFactory : Ljavax/net/ssl/SSLSocketFactory;
    //   47: astore_1
    //   48: aload_0
    //   49: monitorexit
    //   50: aload_1
    ...
    //   from	to	target	type
    //   2	6	52	finally
    //   10	30	33	java/security/GeneralSecurityException
    //   10	30	52	finally
    //   34	44	52	finally
    //   44	48	52	finally
  }
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\OkHttpClient.class
