  ...
  public List<TlsVersion> tlsVersions() {
    ...
    while (true) {
      ...
      if (b < arrayOfString1.length) {
        arrayOfTlsVersion[b] = TlsVersion.forJavaName(arrayOfString1[b]);
        b++;
        continue;
      } 
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\ConnectionSpec.class
