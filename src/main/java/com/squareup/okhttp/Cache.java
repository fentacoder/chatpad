...
public final class Cache {
  ...
  private static final class Entry {
    ...
    public boolean matches(Request param1Request, Response param1Response) {
      boolean bool;
      if (this.url.equals(param1Request.urlString()) && this.requestMethod.equals(param1Request.method()) && OkHeaders.varyMatches(param1Response, this.varyHeaders, param1Request)) {
        bool = true;
      } else {
        bool = false;
      } 
    ...
    public Response response(Request param1Request, DiskLruCache.Snapshot param1Snapshot) {
      ...
      param1Request = (new Request.Builder()).url(this.url).method(this.requestMethod, null).headers(this.varyHeaders).build();
      return (new Response.Builder()).request(param1Request).protocol(this.protocol).code(this.code).message(this.message).headers(this.responseHeaders).body(new Cache.CacheResponseBody(param1Snapshot, str1, str2)).handshake(this.handshake).build();
    }
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\okhttp\Cache.class
