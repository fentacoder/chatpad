...
public class RequestCreator {
  ...
  public RequestCreator centerCrop(int paramInt) {
    this.data.centerCrop(paramInt);
    return this;
  }
  ...
  public void fetch(Callback paramCallback) {
    ...
    if (!this.deferred) {
      if (this.data.hasImage()) {
        ...
        if (MemoryPolicy.shouldReadFromMemoryCache(this.memoryPolicy) && this.picasso.quickMemoryCacheCheck(str) != null) {
  ...
  public void into(ImageView paramImageView, Callback paramCallback) {
    ...
    if (paramImageView != null) {
      ...
      Request request = createRequest(l);
      String str2 = Utils.createKey(request);
      if (MemoryPolicy.shouldReadFromMemoryCache(this.memoryPolicy)) {
        Bitmap bitmap = this.picasso.quickMemoryCacheCheck(str2);
        if (bitmap != null) {
          this.picasso.cancelRequest(paramImageView);
      ...
      if (this.setPlaceholder)
        PicassoDrawable.setPlaceholder((ImageView)str1, getPlaceholderDrawable()); 
      ImageViewAction imageViewAction = new ImageViewAction(this.picasso, (ImageView)str1, (Request)stringBuilder, this.memoryPolicy, this.networkPolicy, this.errorResId, this.errorDrawable, str2, this.tag, paramCallback, this.noFade);
  ...
  public void into(RemoteViews paramRemoteViews, int paramInt1, int paramInt2, Notification paramNotification) {
    into(paramRemoteViews, paramInt1, paramInt2, paramNotification, null);
  }
  
  public void into(RemoteViews paramRemoteViews, int paramInt1, int paramInt2, Notification paramNotification, String paramString) {
    into(paramRemoteViews, paramInt1, paramInt2, paramNotification, paramString, null);
  }
  
  public void into(RemoteViews paramRemoteViews, int paramInt1, int paramInt2, Notification paramNotification, String paramString, Callback paramCallback) {
    long l = System.nanoTime();
      ...
      if (paramNotification != null) {
        if (!this.deferred) {
          if (this.placeholderDrawable == null && this.placeholderResId == 0 && this.errorDrawable == null) {
            Request request = createRequest(l);
            String str = Utils.createKey(request, new StringBuilder());
            performRemoteViewInto(new RemoteViewsAction.NotificationAction(this.picasso, request, paramRemoteViews, paramInt1, paramInt2, paramNotification, paramString, this.memoryPolicy, this.networkPolicy, str, this.tag, this.errorResId, paramCallback));
            return;
          } 
  ...
  public void into(RemoteViews paramRemoteViews, int paramInt, int[] paramArrayOfint) {
    into(paramRemoteViews, paramInt, paramArrayOfint, (Callback)null);
  }
  
  public void into(RemoteViews paramRemoteViews, int paramInt, int[] paramArrayOfint, Callback paramCallback) {
    long l = System.nanoTime();
    if (paramRemoteViews != null) {
      if (paramArrayOfint != null) {
        if (!this.deferred) {
          if (this.placeholderDrawable == null && this.placeholderResId == 0 && this.errorDrawable == null) {
            Request request = createRequest(l);
            String str = Utils.createKey(request, new StringBuilder());
            performRemoteViewInto(new RemoteViewsAction.AppWidgetAction(this.picasso, request, paramRemoteViews, paramInt, paramArrayOfint, this.memoryPolicy, this.networkPolicy, str, this.tag, this.errorResId, paramCallback));
            return;
          } 
          throw new IllegalArgumentException("Cannot use placeholder or error drawables with remote views.");
        } 
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\picasso\RequestCreator.class
