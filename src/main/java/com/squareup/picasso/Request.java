...
public final class Request {
  ...
  private Request(Uri paramUri, int paramInt1, String paramString, List<Transformation> paramList, int paramInt2, int paramInt3, boolean paramBoolean1, boolean paramBoolean2, int paramInt4, boolean paramBoolean3, float paramFloat1, float paramFloat2, float paramFloat3, boolean paramBoolean4, boolean paramBoolean5, Bitmap.Config paramConfig, Picasso.Priority paramPriority) {
    this.uri = paramUri;
    ...
    this.centerCropGravity = paramInt4;
  ...
  public static final class Builder {
    ...
    private Builder(Request param1Request) {
      ...
      this.centerCropGravity = param1Request.centerCropGravity;
      ...
      this.purgeable = param1Request.purgeable;
      this.onlyScaleDown = param1Request.onlyScaleDown;
      if (param1Request.transformations != null)
        this.transformations = new ArrayList<>(param1Request.transformations); 
    ...
    public Builder centerCrop(int param1Int) {
      if (!this.centerInside) {
        this.centerCrop = true;
        this.centerCropGravity = param1Int;
        return this;
      } 
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\squareup\picasso\Request.class
