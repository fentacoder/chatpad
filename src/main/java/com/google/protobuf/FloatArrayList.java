    ...
    if (paramCollection != null) {
      ...
      if (Integer.MAX_VALUE - j >= i) {
        ...
        if (j > arrayOfFloat.length)
          this.array = Arrays.copyOf(arrayOfFloat, j); 
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\protobuf\FloatArrayList.class
