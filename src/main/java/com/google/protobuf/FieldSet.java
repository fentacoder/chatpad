...
final class FieldSet<FieldDescriptorType extends FieldSet.FieldDescriptorLite<FieldDescriptorType>> {
  ...
  private static void verifyType(WireFormat.FieldType paramFieldType, Object paramObject) {
    ...
    //   0: aload_1
    //   1: ifnull -> 185
    //   4: getstatic com/google/protobuf/FieldSet$1.$SwitchMap$com$google$protobuf$WireFormat$JavaType : [I
    //   7: aload_0
    //   8: invokevirtual getJavaType : ()Lcom/google/protobuf/WireFormat$JavaType;
    ...
    //   17: istore_3
    //   18: iload_2
    //   19: tableswitch default -> 68, 1 -> 164, 2 -> 156, 3 -> 148, 4 -> 140, 5 -> 132, 6 -> 124, 7 -> 107, 8 -> 90, 9 -> 71
    //   68: goto -> 169
    //   71: aload_1
    //   72: instanceof com/google/protobuf/MessageLite
    //   75: ifne -> 85
    //   78: aload_1
    //   79: instanceof com/google/protobuf/LazyField
    //   82: ifeq -> 169
    //   85: iconst_1
    //   86: istore_3
    //   87: goto -> 169
    //   90: aload_1
    //   91: instanceof java/lang/Integer
    //   94: ifne -> 85
    //   97: aload_1
    //   98: instanceof com/google/protobuf/Internal$EnumLite
    //   101: ifeq -> 169
    //   104: goto -> 85
    //   107: aload_1
    //   108: instanceof com/google/protobuf/ByteString
    //   111: ifne -> 85
    //   114: aload_1
    //   115: instanceof [B
    //   118: ifeq -> 169
    //   121: goto -> 85
    //   124: aload_1
    //   125: instanceof java/lang/String
    //   128: istore_3
    //   129: goto -> 169
    //   132: aload_1
    //   133: instanceof java/lang/Boolean
    //   136: istore_3
    //   137: goto -> 169
    //   140: aload_1
    //   141: instanceof java/lang/Double
    //   144: istore_3
    //   145: goto -> 169
    //   148: aload_1
    //   149: instanceof java/lang/Float
    //   152: istore_3
    //   153: goto -> 169
    //   156: aload_1
    //   157: instanceof java/lang/Long
    //   160: istore_3
    //   161: goto -> 169
    //   164: aload_1
    //   165: instanceof java/lang/Integer
    //   168: istore_3
    //   169: iload_3
    //   170: ifeq -> 174
    //   173: return
    ...
    //   177: dup
    //   178: ldc_w 'Wrong object type used with protocol message reflection.'
    //   181: invokespecial <init> : (Ljava/lang/String;)V
    //   184: athrow
    //   185: new java/lang/NullPointerException
    //   188: dup
  ...
  public Object getField(FieldDescriptorType paramFieldDescriptorType) {
    ...
    Object object = this.fields.get(paramFieldDescriptorType);
    paramFieldDescriptorType = (FieldDescriptorType)object;
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\protobuf\FieldSet.class
