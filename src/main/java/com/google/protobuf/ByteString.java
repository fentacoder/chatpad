      ...
      if (param1Int2 <= param1ByteString.size()) {
        ...
        if (i <= param1ByteString.size()) {
          if (param1ByteString instanceof LiteralByteString) {
            ...
            int k = param1ByteString.getOffsetIntoBytes() + param1Int1;
            param1Int1 = i;
            for (i = k; param1Int1 < j + param1Int2; i++) {
              if (arrayOfByte1[param1Int1] != arrayOfByte2[i])
                return false; 
              param1Int1++;
            } 
            return true;
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\protobuf\ByteString.class
