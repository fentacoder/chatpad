...
public final class Duration extends GeneratedMessageLite<Duration, Duration.Builder> implements DurationOrBuilder {
  ...
  public static Duration parseDelimitedFrom(InputStream paramInputStream) throws IOException {
    return (Duration)parseDelimitedFrom(DEFAULT_INSTANCE, paramInputStream);
  }
  ...
  public static Duration parseDelimitedFrom(InputStream paramInputStream, ExtensionRegistryLite paramExtensionRegistryLite) throws IOException {
    return (Duration)parseDelimitedFrom(DEFAULT_INSTANCE, paramInputStream, paramExtensionRegistryLite);
  }
  
  public static Duration parseFrom(ByteString paramByteString) throws InvalidProtocolBufferException {
    return GeneratedMessageLite.<Duration>parseFrom(DEFAULT_INSTANCE, paramByteString);
  }
  ...
  public static Duration parseFrom(ByteString paramByteString, ExtensionRegistryLite paramExtensionRegistryLite) throws InvalidProtocolBufferException {
    return GeneratedMessageLite.<Duration>parseFrom(DEFAULT_INSTANCE, paramByteString, paramExtensionRegistryLite);
  }
  
  public static Duration parseFrom(CodedInputStream paramCodedInputStream) throws IOException {
    return GeneratedMessageLite.<Duration>parseFrom(DEFAULT_INSTANCE, paramCodedInputStream);
  }
  ...
  public static Duration parseFrom(CodedInputStream paramCodedInputStream, ExtensionRegistryLite paramExtensionRegistryLite) throws IOException {
    return GeneratedMessageLite.<Duration>parseFrom(DEFAULT_INSTANCE, paramCodedInputStream, paramExtensionRegistryLite);
  }
  
  public static Duration parseFrom(InputStream paramInputStream) throws IOException {
    return GeneratedMessageLite.<Duration>parseFrom(DEFAULT_INSTANCE, paramInputStream);
  }
  ...
  public static Duration parseFrom(InputStream paramInputStream, ExtensionRegistryLite paramExtensionRegistryLite) throws IOException {
    return GeneratedMessageLite.<Duration>parseFrom(DEFAULT_INSTANCE, paramInputStream, paramExtensionRegistryLite);
  }
  
  public static Duration parseFrom(byte[] paramArrayOfbyte) throws InvalidProtocolBufferException {
    return GeneratedMessageLite.<Duration>parseFrom(DEFAULT_INSTANCE, paramArrayOfbyte);
  }
  ...
  public static Duration parseFrom(byte[] paramArrayOfbyte, ExtensionRegistryLite paramExtensionRegistryLite) throws InvalidProtocolBufferException {
    return GeneratedMessageLite.<Duration>parseFrom(DEFAULT_INSTANCE, paramArrayOfbyte, paramExtensionRegistryLite);
  }
  ...
  protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke paramMethodToInvoke, Object paramObject1, Object paramObject2) {
    // Byte code:
    //   0: getstatic com/google/protobuf/Duration$1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke : [I
    //   3: aload_1
    ...
    //   71: athrow
    //   72: getstatic com/google/protobuf/Duration.PARSER : Lcom/google/protobuf/Parser;
    //   75: ifnonnull -> 114
    //   78: ldc com/google/protobuf/Duration
    //   80: monitorenter
    //   81: getstatic com/google/protobuf/Duration.PARSER : Lcom/google/protobuf/Parser;
    //   84: ifnonnull -> 102
    //   87: new com/google/protobuf/GeneratedMessageLite$DefaultInstanceBasedParser
    //   90: astore_1
    //   91: aload_1
    //   92: getstatic com/google/protobuf/Duration.DEFAULT_INSTANCE : Lcom/google/protobuf/Duration;
    //   95: invokespecial <init> : (Lcom/google/protobuf/GeneratedMessageLite;)V
    //   98: aload_1
    //   99: putstatic com/google/protobuf/Duration.PARSER : Lcom/google/protobuf/Parser;
    //   102: ldc com/google/protobuf/Duration
    //   104: monitorexit
    //   105: goto -> 114
    //   108: astore_1
    //   109: ldc com/google/protobuf/Duration
    //   111: monitorexit
    //   112: aload_1
    //   113: athrow
    //   114: getstatic com/google/protobuf/Duration.PARSER : Lcom/google/protobuf/Parser;
    //   117: areturn
    //   118: aload_2
    ...
    //   246: aload_1
    //   247: athrow
    //   248: getstatic com/google/protobuf/Duration.DEFAULT_INSTANCE : Lcom/google/protobuf/Duration;
    //   251: areturn
    //   252: aload_2
    //   253: checkcast com/google/protobuf/GeneratedMessageLite$Visitor
    //   256: astore_1
    //   257: aload_3
    //   258: checkcast com/google/protobuf/Duration
    //   261: astore_2
    //   262: aload_0
    ...
    //   384: aload_0
    //   385: areturn
    //   386: new com/google/protobuf/Duration$Builder
    //   389: dup
    //   390: aconst_null
    //   391: invokespecial <init> : (Lcom/google/protobuf/Duration$1;)V
    //   394: areturn
    //   395: aconst_null
    //   396: areturn
    //   397: getstatic com/google/protobuf/Duration.DEFAULT_INSTANCE : Lcom/google/protobuf/Duration;
    //   400: areturn
    //   401: new com/google/protobuf/Duration
    //   404: dup
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\protobuf\Duration.class
