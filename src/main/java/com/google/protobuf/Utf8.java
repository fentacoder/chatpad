  ...
  static final class UnsafeProcessor extends Processor {
    ...
    int encodeUtf8(CharSequence param1CharSequence, byte[] param1ArrayOfbyte, int param1Int1, int param1Int2) {
      ...
      if (i <= param1Int2 && param1ArrayOfbyte.length - param1Int2 >= param1Int1) {
        ...
        long l4 = l1;
        if (param1Int2 == i) {
          l3 = UnsafeUtil.getArrayBaseOffset();
          return (int)(l1 - l3);
        } 
        while (param1Int1 < i) {
          char c = param1CharSequence.charAt(param1Int1);
          if (c < j && l4 < l2) {
            ...
            if (param1Int2 != i) {
              ...
              if (Character.isSurrogatePair(c, c1)) {
                ...
                l1 = l4 + 1L;
                UnsafeUtil.putByte(param1ArrayOfbyte, l4, (byte)(j >>> 18 | 0xF0));
                l3 = l1 + 1L;
                param1Int1 = 128;
                UnsafeUtil.putByte(param1ArrayOfbyte, l1, (byte)(j >>> 12 & 0x3F | 0x80));
                l4 = l3 + 1L;
                UnsafeUtil.putByte(param1ArrayOfbyte, l3, (byte)(j >>> 6 & 0x3F | 0x80));
                l3 = 1L;
                l1 = l4 + 1L;
                UnsafeUtil.putByte(param1ArrayOfbyte, l4, (byte)(j & 0x3F | 0x80));
              } else {
                param1Int1 = param1Int2;
                throw new Utf8.UnpairedSurrogateException(param1Int1 - 1, i);
              } 
        ...
        long l3 = UnsafeUtil.getArrayBaseOffset();
        l1 = l4;
        return (int)(l1 - l3);
      } 
                ...
                if (l5 <= l3 - 4L) {
                  ...
                  if (j != i) {
                    ...
                    if (Character.isSurrogatePair(c, c1)) {
                      ...
                      l5 = l2 + 1L;
                      m = 128;
                      UnsafeUtil.putByte(l2, (byte)(k >>> 12 & 0x3F | 0x80));
                      l2 = l5 + 1L;
                      UnsafeUtil.putByte(l5, (byte)(k >>> 6 & 0x3F | 0x80));
                      UnsafeUtil.putByte(l2, (byte)(k & 0x3F | 0x80));
                      l2++;
                    } else {
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\protobuf\Utf8.class
