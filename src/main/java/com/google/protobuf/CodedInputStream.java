...
public final class CodedInputStream {
    ...
    if (k <= this.sizeLimit) {
      ...
      if (k <= m) {
        ...
        if (inputStream != null) {
          m = this.bufferSize;
          k = m - j;
          this.totalBytesRetired = i + m;
          this.bufferPos = 0;
          this.bufferSize = 0;
          i = paramInt - k;
          if (i < 4096 || i <= inputStream.available()) {
            byte[] arrayOfByte1 = new byte[paramInt];
            System.arraycopy(this.buffer, j, arrayOfByte1, 0, k);
            while (k < arrayOfByte1.length) {
              i = this.input.read(arrayOfByte1, k, paramInt - k);
              if (i != -1) {
          ...
          System.arraycopy(this.buffer, j, arrayOfByte, 0, k);
  ...
  public ByteBuffer readByteBuffer() throws IOException {
    ...
    if (i <= j - k && i > 0) {
      ...
      if (this.input == null && !this.bufferIsImmutable && this.enableAliasing) {
        ...
        byte[] arrayOfByte = this.buffer;
        k = this.bufferPos;
        byteBuffer = ByteBuffer.wrap(Arrays.copyOfRange(arrayOfByte, k, k + i));
      } 
      this.bufferPos += i;
      return byteBuffer;
    } 
  ...
  public int readRawLittleEndian32() throws IOException {
    ...
    return (arrayOfByte[j + 3] & 0xFF) << 24 | i & 0xFF | (b1 & 0xFF) << 8 | (b2 & 0xFF) << 16;
  }
      ...
      if (i >= 0) {
        ...
        if (k < 0) {
          ...
          if (l2 >= 0L) {
            ...
            i = k + 1;
            l2 ^= arrayOfByte[k] << 35L;
            if (l2 < 0L) {
              l3 = -34093383808L;
              j = i;
            } else {
              j = i + 1;
              l2 ^= arrayOfByte[i] << 42L;
              if (l2 >= 0L) {
                l3 = 4363953127296L;
              } else {
                i = j + 1;
                l2 ^= arrayOfByte[j] << 49L;
                if (l2 < 0L) {
                  l3 = -558586000294016L;
                  j = i;
                } else {
  ...
  public String readStringRequireUtf8() throws IOException {
    ...
    if (Utf8.isValidUtf8(arrayOfByte, m, m + i))
      return new String(arrayOfByte, m, i, Internal.UTF_8); 
  ...
  public boolean skipField(int paramInt, CodedOutputStream paramCodedOutputStream) throws IOException {
    ...
    if (i != 0) {
      ...
      paramCodedOutputStream.writeRawVarint32(paramInt);
      paramCodedOutputStream.writeFixed64NoTag(l1);
      return true;
    } 
    long l = readInt64();
    paramCodedOutputStream.writeRawVarint32(paramInt);
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\protobuf\CodedInputStream.class
