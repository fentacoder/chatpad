      ...
      if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
        ...
        for (l = l1;; l = 1L + l) {
          if ((param1Long & 0xFFFFFFFFFFFFFF80L) == 0L) {
            UnsafeUtil.putByte(this.buffer, l, (byte)(int)param1Long);
            int i = (int)(1L + l - l1);
            this.position += i;
            this.totalBytesWritten += i;
            return;
          } 
          UnsafeUtil.putByte(this.buffer, l, (byte)((int)param1Long & 0x7F | 0x80));
          param1Long >>>= 7L;
        } 
      } 
      while (true) {
  ...
  private static class ArrayEncoder extends CodedOutputStream {
    ...
    public final void writeUInt64NoTag(long param1Long) throws IOException {
      ...
      if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
        l = param1Long;
        if (spaceLeft() >= 10)
          for (l = CodedOutputStream.ARRAY_BASE_OFFSET + this.position;; l = 1L + l) {
            if ((param1Long & 0xFFFFFFFFFFFFFF80L) == 0L) {
              UnsafeUtil.putByte(this.buffer, l, (byte)(int)param1Long);
              this.position++;
              return;
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\protobuf\CodedOutputStream.class
