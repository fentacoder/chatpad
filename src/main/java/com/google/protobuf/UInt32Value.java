...
public final class UInt32Value extends GeneratedMessageLite<UInt32Value, UInt32Value.Builder> implements UInt32ValueOrBuilder {
  ...
  public static UInt32Value parseFrom(ByteString paramByteString) throws InvalidProtocolBufferException {
    return GeneratedMessageLite.<UInt32Value>parseFrom(DEFAULT_INSTANCE, paramByteString);
  }
  ...
  public static UInt32Value parseFrom(ByteString paramByteString, ExtensionRegistryLite paramExtensionRegistryLite) throws InvalidProtocolBufferException {
    return GeneratedMessageLite.<UInt32Value>parseFrom(DEFAULT_INSTANCE, paramByteString, paramExtensionRegistryLite);
  }
  
  public static UInt32Value parseFrom(CodedInputStream paramCodedInputStream) throws IOException {
    return GeneratedMessageLite.<UInt32Value>parseFrom(DEFAULT_INSTANCE, paramCodedInputStream);
  }
  ...
  public static UInt32Value parseFrom(CodedInputStream paramCodedInputStream, ExtensionRegistryLite paramExtensionRegistryLite) throws IOException {
    return GeneratedMessageLite.<UInt32Value>parseFrom(DEFAULT_INSTANCE, paramCodedInputStream, paramExtensionRegistryLite);
  }
  
  public static UInt32Value parseFrom(InputStream paramInputStream) throws IOException {
    return GeneratedMessageLite.<UInt32Value>parseFrom(DEFAULT_INSTANCE, paramInputStream);
  }
  ...
  public static UInt32Value parseFrom(InputStream paramInputStream, ExtensionRegistryLite paramExtensionRegistryLite) throws IOException {
    return GeneratedMessageLite.<UInt32Value>parseFrom(DEFAULT_INSTANCE, paramInputStream, paramExtensionRegistryLite);
  }
  
  public static UInt32Value parseFrom(byte[] paramArrayOfbyte) throws InvalidProtocolBufferException {
    return GeneratedMessageLite.<UInt32Value>parseFrom(DEFAULT_INSTANCE, paramArrayOfbyte);
  }
  ...
  public static UInt32Value parseFrom(byte[] paramArrayOfbyte, ExtensionRegistryLite paramExtensionRegistryLite) throws InvalidProtocolBufferException {
    return GeneratedMessageLite.<UInt32Value>parseFrom(DEFAULT_INSTANCE, paramArrayOfbyte, paramExtensionRegistryLite);
  }
  ...
  protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke paramMethodToInvoke, Object paramObject1, Object paramObject2) {
    // Byte code:
    //   0: getstatic com/google/protobuf/UInt32Value$1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke : [I
    //   3: aload_1
    ...
    //   71: athrow
    //   72: getstatic com/google/protobuf/UInt32Value.PARSER : Lcom/google/protobuf/Parser;
    //   75: ifnonnull -> 114
    //   78: ldc com/google/protobuf/UInt32Value
    //   80: monitorenter
    //   81: getstatic com/google/protobuf/UInt32Value.PARSER : Lcom/google/protobuf/Parser;
    //   84: ifnonnull -> 102
    //   87: new com/google/protobuf/GeneratedMessageLite$DefaultInstanceBasedParser
    //   90: astore_1
    //   91: aload_1
    //   92: getstatic com/google/protobuf/UInt32Value.DEFAULT_INSTANCE : Lcom/google/protobuf/UInt32Value;
    //   95: invokespecial <init> : (Lcom/google/protobuf/GeneratedMessageLite;)V
    //   98: aload_1
    //   99: putstatic com/google/protobuf/UInt32Value.PARSER : Lcom/google/protobuf/Parser;
    //   102: ldc com/google/protobuf/UInt32Value
    //   104: monitorexit
    //   105: goto -> 114
    //   108: astore_1
    //   109: ldc com/google/protobuf/UInt32Value
    //   111: monitorexit
    //   112: aload_1
    //   113: athrow
    //   114: getstatic com/google/protobuf/UInt32Value.PARSER : Lcom/google/protobuf/Parser;
    //   117: areturn
    //   118: aload_2
    ...
    //   163: aload_0
    //   164: aload_1
    //   165: invokevirtual readUInt32 : ()I
    ...
    //   228: aload_1
    //   229: athrow
    //   230: getstatic com/google/protobuf/UInt32Value.DEFAULT_INSTANCE : Lcom/google/protobuf/UInt32Value;
    //   233: areturn
    //   234: aload_2
    //   235: checkcast com/google/protobuf/GeneratedMessageLite$Visitor
    //   238: astore_1
    //   239: aload_3
    //   240: checkcast com/google/protobuf/UInt32Value
    //   243: astore_2
    //   244: aload_0
    ...
    //   300: aload_0
    //   301: areturn
    //   302: new com/google/protobuf/UInt32Value$Builder
    //   305: dup
    //   306: aconst_null
    //   307: invokespecial <init> : (Lcom/google/protobuf/UInt32Value$1;)V
    //   310: areturn
    //   311: aconst_null
    //   312: areturn
    //   313: getstatic com/google/protobuf/UInt32Value.DEFAULT_INSTANCE : Lcom/google/protobuf/UInt32Value;
    //   316: areturn
    //   317: new com/google/protobuf/UInt32Value
    //   320: dup
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\protobuf\UInt32Value.class
