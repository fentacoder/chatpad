...
class SmallSortedMap<K extends Comparable<K>, V> extends AbstractMap<K, V> {
  ...
  public V put(K paramK, V paramV) {
    ...
    int k = this.entryList.size();
    i = this.maxArraySize;
    if (k == i) {
      Entry entry = this.entryList.remove(i - 1);
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\protobuf\SmallSortedMap.class
