...
public final class Help extends GeneratedMessageLite<Help, Help.Builder> implements HelpOrBuilder {
  ...
  protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke paramMethodToInvoke, Object paramObject1, Object paramObject2) {
    ...
    //   155: goto -> 205
    //   158: aload_0
    //   159: getfield links_ : Lcom/google/protobuf/Internal$ProtobufList;
    //   162: invokeinterface isModifiable : ()Z
    //   167: ifne -> 181
    //   170: aload_0
    //   171: aload_0
    //   172: getfield links_ : Lcom/google/protobuf/Internal$ProtobufList;
    //   175: invokestatic mutableCopy : (Lcom/google/protobuf/Internal$ProtobufList;)Lcom/google/protobuf/Internal$ProtobufList;
    //   178: putfield links_ : Lcom/google/protobuf/Internal$ProtobufList;
    //   181: aload_0
    //   182: getfield links_ : Lcom/google/protobuf/Internal$ProtobufList;
    //   185: aload_1
    ...
    //   193: checkcast com/google/rpc/Help$Link
    ...
    //   259: aload_1
    //   260: athrow
    //   261: getstatic com/google/rpc/Help.DEFAULT_INSTANCE : Lcom/google/rpc/Help;
    //   264: areturn
    //   265: aload_2
    //   266: checkcast com/google/protobuf/GeneratedMessageLite$Visitor
    //   269: astore_1
    //   270: aload_3
    //   271: checkcast com/google/rpc/Help
    //   274: astore_2
    //   275: aload_0
    //   276: aload_1
    //   277: aload_0
    //   278: getfield links_ : Lcom/google/protobuf/Internal$ProtobufList;
    //   281: aload_2
    //   282: getfield links_ : Lcom/google/protobuf/Internal$ProtobufList;
    ...
    //   290: putfield links_ : Lcom/google/protobuf/Internal$ProtobufList;
    ...
    //   297: aload_0
    //   298: areturn
    //   299: new com/google/rpc/Help$Builder
    //   302: dup
    //   303: aconst_null
    //   304: invokespecial <init> : (Lcom/google/rpc/Help$1;)V
    //   307: areturn
    //   308: aload_0
    //   309: getfield links_ : Lcom/google/protobuf/Internal$ProtobufList;
    //   312: invokeinterface makeImmutable : ()V
    //   317: aconst_null
    //   318: areturn
    //   319: getstatic com/google/rpc/Help.DEFAULT_INSTANCE : Lcom/google/rpc/Help;
    //   322: areturn
    //   323: new com/google/rpc/Help
    //   326: dup
  ...
  public int getSerializedSize() {
    ...
    byte b = 0;
    i = 0;
    while (b < this.links_.size()) {
      i += CodedOutputStream.computeMessageSize(1, (MessageLite)this.links_.get(b));
      b++;
    } 
  ...
  public static final class Link extends GeneratedMessageLite<Link, Link.Builder> implements LinkOrBuilder {
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke param1MethodToInvoke, Object param1Object1, Object param1Object2) {
      ...
      //   170: putfield url_ : Ljava/lang/String;
      //   173: goto -> 123
      //   176: aload_0
      //   177: aload_1
      //   178: invokevirtual readStringRequireUtf8 : ()Ljava/lang/String;
      //   181: putfield description_ : Ljava/lang/String;
      //   184: goto -> 123
      //   187: iconst_1
      //   188: istore #4
      //   190: goto -> 123
      ...
      //   241: aload_1
      //   242: athrow
      //   243: getstatic com/google/rpc/Help$Link.DEFAULT_INSTANCE : Lcom/google/rpc/Help$Link;
      //   246: areturn
      //   247: aload_2
      //   248: checkcast com/google/protobuf/GeneratedMessageLite$Visitor
      //   251: astore_1
      //   252: aload_3
      //   253: checkcast com/google/rpc/Help$Link
      //   256: astore_2
      //   257: aload_0
      //   258: aload_1
      //   259: aload_0
      //   260: getfield description_ : Ljava/lang/String;
      //   263: invokevirtual isEmpty : ()Z
      //   266: iconst_1
      //   267: ixor
      //   268: aload_0
      //   269: getfield description_ : Ljava/lang/String;
      //   272: aload_2
      //   273: getfield description_ : Ljava/lang/String;
      //   276: invokevirtual isEmpty : ()Z
      //   279: iconst_1
      //   280: ixor
      //   281: aload_2
      //   282: getfield description_ : Ljava/lang/String;
      //   285: invokeinterface visitString : (ZLjava/lang/String;ZLjava/lang/String;)Ljava/lang/String;
      //   290: putfield description_ : Ljava/lang/String;
      //   293: aload_0
      //   294: aload_1
      //   295: aload_0
      //   296: getfield url_ : Ljava/lang/String;
      //   299: invokevirtual isEmpty : ()Z
      //   302: iconst_1
      //   303: ixor
      //   304: aload_0
      //   305: getfield url_ : Ljava/lang/String;
      //   308: iconst_1
      //   309: aload_2
      //   310: getfield url_ : Ljava/lang/String;
      //   313: invokevirtual isEmpty : ()Z
      //   316: ixor
      //   317: aload_2
      //   318: getfield url_ : Ljava/lang/String;
      //   321: invokeinterface visitString : (ZLjava/lang/String;ZLjava/lang/String;)Ljava/lang/String;
      //   326: putfield url_ : Ljava/lang/String;
      ...
      //   333: aload_0
      //   334: areturn
      //   335: new com/google/rpc/Help$Link$Builder
      //   338: dup
      //   339: aconst_null
      //   340: invokespecial <init> : (Lcom/google/rpc/Help$1;)V
      //   343: areturn
      //   344: aconst_null
      //   345: areturn
      //   346: getstatic com/google/rpc/Help$Link.DEFAULT_INSTANCE : Lcom/google/rpc/Help$Link;
      //   349: areturn
      //   350: new com/google/rpc/Help$Link
      //   353: dup
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\rpc\Help.class
