...
public final class ComponentDiscovery<T> {
  ...
  public static ComponentDiscovery<Context> forContext(Context paramContext, Class<? extends Service> paramClass) {
    return new ComponentDiscovery<>(paramContext, new MetadataRegistrarNameRetriever(paramClass));
  }
  ...
  private static class MetadataRegistrarNameRetriever implements RegistrarNameRetriever<Context> {
    ...
    private MetadataRegistrarNameRetriever(Class<? extends Service> param1Class) {
      this.discoveryService = param1Class;
    }
    
    private Bundle getMetadata(Context param1Context) {
      try {
        ...
        this(param1Context, this.discoveryService);
        ServiceInfo serviceInfo = packageManager.getServiceInfo(componentName, 128);
        if (serviceInfo == null) {
          stringBuilder = new StringBuilder();
          this();
          stringBuilder.append(this.discoveryService);
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\firebase\components\ComponentDiscovery.class
