...
public class ComponentRuntime extends AbstractComponentContainer {
  ...
  public ComponentRuntime(Executor paramExecutor, Iterable<ComponentRegistrar> paramIterable, Component<?>... paramVarArgs) {
    ...
    byte b = 0;
    arrayList.add(Component.of(eventBus, EventBus.class, (Class<? super EventBus>[])new Class[] { Subscriber.class, Publisher.class }));
    ...
    while (b < i) {
      Component<?> component = paramVarArgs[b];
      if (component != null)
  ...
  private void processSetComponents() {
    ...
    for (Map.Entry<Object, Object> entry : hashMap.entrySet()) {
      ...
      this.lazySetMap.put((Class)entry.getKey(), new Lazy<>(ComponentRuntime$$Lambda$4.lambdaFactory$(set)));
    } 
  }
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\firebase\components\ComponentRuntime.class
