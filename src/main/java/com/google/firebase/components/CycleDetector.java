...
class CycleDetector {
  ...
  private static Set<ComponentNode> toGraph(List<Component<?>> paramList) {
    HashMap<Object, Object> hashMap = new HashMap<>(paramList.size());
    ...
    while (iterator2.hasNext()) {
      for (ComponentNode componentNode : iterator2.next()) {
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\firebase\components\CycleDetector.class
