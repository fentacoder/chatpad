...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
  ...
  static <K, V> Node<K, V>[] doubleCapacity(Node<K, V>[] paramArrayOfNode) {
    ...
    AvlIterator<Object, Object> avlIterator = new AvlIterator<>();
    AvlBuilder<Object, Object> avlBuilder1 = new AvlBuilder<>();
    AvlBuilder<Object, Object> avlBuilder2 = new AvlBuilder<>();
    for (byte b = 0; b < i; b++) {
  ...
  Node<K, V> find(K paramK, boolean paramBoolean) {
    ...
    if (node2 == null) {
      if (comparator != NATURAL_ORDER || paramK instanceof Comparable) {
        node1 = new Node<>(node2, paramK, i, node3, node3.prev);
        arrayOfNode[j] = node1;
      } else {
      ...
      node1 = new Node<>((Node<K, V>)stringBuilder, (K)node1, i, node3, node3.prev);
      if (k) {
  ...
  void removeInternal(Node<K, V> paramNode, boolean paramBoolean) {
    ...
    if (node1 != null && node2 != null) {
      ...
      node3.height = Math.max(bool, i) + 1;
      ...
      while (true) {
        ...
        if ((j & k) == k) {
          ...
          if (j == 0) {
            ...
            param1Node = node2.parent;
            node2.parent = param1Node.parent;
            this.stack = node2;
            node2.left = param1Node;
            node2.right = node1;
            node1.height++;
            param1Node.parent = node2;
            node1.parent = node2;
          } else if (j == 1) {
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\gson\internal\LinkedHashTreeMap.class
