...
public final class CollectionTypeAdapterFactory implements TypeAdapterFactory {
  ...
  private static final class Adapter<E> extends TypeAdapter<Collection<E>> {
    ...
    public Adapter(Gson param1Gson, Type param1Type, TypeAdapter<E> param1TypeAdapter, ObjectConstructor<? extends Collection<E>> param1ObjectConstructor) {
      this.elementTypeAdapter = new TypeAdapterRuntimeTypeWrapper<>(param1Gson, param1TypeAdapter, param1Type);
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\gson\internal\bind\CollectionTypeAdapterFactory.class
