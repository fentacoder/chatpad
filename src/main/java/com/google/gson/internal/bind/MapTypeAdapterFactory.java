...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
  ...
  public <T> TypeAdapter<T> create(Gson paramGson, TypeToken<T> paramTypeToken) {
    ...
    return (TypeAdapter)new Adapter<>(paramGson, arrayOfType[0], typeAdapter2, arrayOfType[1], typeAdapter1, objectConstructor);
  }
  ...
  private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
    ...
    public Adapter(Gson param1Gson, Type param1Type1, TypeAdapter<K> param1TypeAdapter, Type param1Type2, TypeAdapter<V> param1TypeAdapter1, ObjectConstructor<? extends Map<K, V>> param1ObjectConstructor) {
      this.keyTypeAdapter = new TypeAdapterRuntimeTypeWrapper<>(param1Gson, param1TypeAdapter, param1Type1);
      this.valueTypeAdapter = new TypeAdapterRuntimeTypeWrapper<>(param1Gson, param1TypeAdapter1, param1Type2);
    ...
    public void write(JsonWriter param1JsonWriter, Map<K, V> param1Map) throws IOException {
      ...
      ArrayList<JsonElement> arrayList1 = new ArrayList(entry.size());
      ...
      if (i != 0) {
        ...
        for (i = bool2; i < arrayList1.size(); i++) {
          param1JsonWriter.beginArray();
        ...
        param1JsonWriter.beginObject();
        for (i = bool1; i < arrayList1.size(); i++) {
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\gson\internal\bind\MapTypeAdapterFactory.class
