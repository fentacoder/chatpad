...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
  ...
  public <T> TypeAdapter<T> create(Gson paramGson, TypeToken<T> paramTypeToken) {
    ...
    return !Object.class.isAssignableFrom(clazz) ? null : new Adapter<>(this.constructorConstructor.get(paramTypeToken), getBoundFields(paramGson, paramTypeToken, clazz));
  }
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\gson\internal\bind\ReflectiveTypeAdapterFactory.class
