  ...
  Node<K, V> find(K paramK, boolean paramBoolean) {
    ...
    if (node2 == null) {
      if (comparator != NATURAL_ORDER || paramK instanceof Comparable) {
        node1 = new Node<>(node2, paramK, node3, node3.prev);
        this.root = node1;
        this.size++;
        this.modCount++;
        return node1;
    ...
    Node<K, V> node1 = new Node<>((Node<K, V>)stringBuilder, (K)node1, node3, node3.prev);
    if (bool) {
...
/* Location:              C:\Users\jamar\Documents\android_location\apk_conversion\dex2jar-3.0\classes2-dex2jar.jar!\com\google\gson\internal\LinkedTreeMap.class
